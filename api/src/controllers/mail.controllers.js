...
const sendEmail = async (req, res) => {
  ...
  if (orderStatus === "completed") {
    ...
    <div style="margin: 10px;font-family: sans-serif;font-weight: bold;"><a href="${REACT_HOST}/orders" class="button">Detalle de tu compra</a></div>
    <div style="margin: 10px">
    <form action="${REACT_HOST}/orders">
  ...
  if (orderStatus === "dispatched") {
    ...
    <div style="margin: 10px;font-family: sans-serif;font-weight: bold;"> Username: ${orderEmail}</div> 
    <div style="margin: 10px;font-family: sans-serif;">Full Name: ${customer.fullName}</div>
    <div style="margin: 10px;font-family: sans-serif;font-weight: bold;"> Shipping Address: ${shippingAddress}}</div>
    <div style="margin: 10px;font-family: sans-serif;font-weight: bold;"><a href="${REACT_HOST}/orders" class="button">Detalle de tu compra</a></div>
    <div style="margin: 10px">
    <form action="${REACT_HOST}/orders">
    <input style="margin-top: 30px;border-radius: 5px;background-color: rgb(106, 203, 233);cursor: pointer" type="submit" value="Purchase Detail" />
  ...
  if (orderStatus === "cancelled") {
    const contentHTML = `
    <div style="display: flex;flex-direction: column;align-items: center;border-radius: 15px;text-align: center;background-color: rgb(255, 0, 0);width: 600px;">
    <div style="display: flex;flex-direction: column;align-items: center;border-radius: 15px;text-align: center;background-color: rgb(255, 0, 0);width: 400px;">
